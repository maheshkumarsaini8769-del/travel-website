...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/tour-packages`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${base}/rajasthan-tour-packages`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${base}/india-tour-packages`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/international-tour-packages`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/flight-booking`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/hotel-booking`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/visa-assistance`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/transportation`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    ...
    { url: `${base}/travel-guides`, lastModified: now, changeFrequency: 'weekly', priority: 0.75 },
